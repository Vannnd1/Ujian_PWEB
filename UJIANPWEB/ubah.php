...
// Mengambil data dari npm dengan fungsi get
$npm = $_GET['npm'];

// Mengambil data dari table Mahasiswa dari npm
$siswa = query("SELECT * FROM mahasiswa WHERE npm = $npm")[0];
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="npm" value="<?= $siswa['npm']; ?>" name="npm" readonly>
                    </div>
                    <div class="mb-3">
